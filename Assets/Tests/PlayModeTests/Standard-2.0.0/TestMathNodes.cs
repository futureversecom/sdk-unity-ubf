...
// 			Value2 = value2,
// 			Evaluator = evaluator ?? (actual => { Assert.AreEqual(actual, expectedResult);}),
// 			Node = new Subtract<T>("Subtract", type),
// 			NodeName = "Subtract",
// 		};
// 	}
// 	
...
// 			Value2 = value2,
// 			Evaluator = evaluator ?? (actual => { Assert.AreEqual(actual, expectedResult);}),
// 			Node = new Multiply<T>("Multiply", type),
// 			NodeName = "Multiply",
// 		};
// 	}
//
...
// 			Value1 = value1,
// 			Value2 = value2,
// 			Node = new Subtract<T>("Subtract", type1),
// 			NodeName = "Subtract",
// 		};
// 	}
// 	
...
// 			Value1 = value1,
// 			Value2 = value2,
// 			Node = new Multiply<T>("Multiply", type1),
// 			NodeName = "Multiply",
// 		};
// 	}
// 	

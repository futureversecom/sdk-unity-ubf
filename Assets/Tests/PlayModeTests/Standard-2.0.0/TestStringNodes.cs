...
// using Contains = UnitTests.PlayModeTests.Utils.Contains;
//
...
// 			.AddNode(new Contains("Contains1", Substring:"world", IgnoreCase:true))
// 			.AddNode(new Contains("Contains2", Substring:"world", IgnoreCase:false))
...
// 			.AddInputWithNode<string>("String2", "string", string2)
// 			.AddOutputWithNode("Result", "string")
// 			.AddNode(new FormatString("FormatString", Item:TestUtils.DefaultList<string>(2)))
// 			.ConnectEntry("Set_Result")
...
// 			.AddInputWithNode<string>("testString", "string", testString)
// 			.AddOutputWithNode("Result", "string")
// 			.AddNode(new Replace("Replace1", ToReplace:"Hello", Replacement:"Goodbye"))
// 			.AddNode(new Replace("Replace2", ToReplace:"Foo", Replacement:"Bar"))
// 			.ConnectEntry("Set_Result")
...
// 			.AddNode(new Split("Split", Separator:","))
// 			.ConnectEntry("Set_Result")
...
// 			.AddOutputWithNode("Result", "string")
// 			.AddNode(new ToString<T>("ToString", testCase.Type))
// 			.ConnectEntry("Set_Result")
...
// 		var graph = new TestGraphBuilder(BlueprintVersion.Version)
// 			.AddOutputWithNode("Result", "string")
// 			.AddNode(new CreateSceneNode("CreateSceneNode", "Parent"))
// 			.AddNode(new ToString<Transform>("ToString", "SceneNode"))

...
// 			.AddNode(new And("And1", true, true))
// 			.AddNode(new And("And2", true, false))
// 			.AddNode(new And("And3", false, false))
...
// 			.AddOutputWithNode("Result2", "boolean")
// 			.AddOutputWithNode("Result3", "boolean")
// 			.AddNode(new Or("Or1", true, true))
// 			.AddNode(new Or("Or2", true, false))
// 			.AddNode(new Or("Or3", false, false))
// 			.ConnectEntry("Set_Result1")
// 			.ConnectExecution("Set_Result1", "Set_Result2")
// 			.ConnectExecution("Set_Result2", "Set_Result3")
...
// 			.AddOutputWithNode("Result2", "boolean")
// 			.AddOutputWithNode("Result3", "boolean")
// 			.AddNode(new Xor("Xor1", true, true))
// 			.AddNode(new Xor("Xor2", true, false))
// 			.AddNode(new Xor("Xor3", false, false))
// 			.ConnectEntry("Set_Result1")
// 			.ConnectExecution("Set_Result1", "Set_Result2")
// 			.ConnectExecution("Set_Result2", "Set_Result3")
...
// 			.AddOutputWithNode("Result1", "boolean")
// 			.AddOutputWithNode("Result2", "boolean")
// 			.AddNode(new Not("Not1",true))
// 			.AddNode(new Not("Not2",false))
// 			.ConnectEntry("Set_Result1")
// 			.ConnectExecution("Set_Result1", "Set_Result2")
...
// 			Value1 = value1,
// 			Value2 = value2,
// 			Node = new GreaterThan<T>("GreaterThan", type),
...
// 			Value1 = value1,
// 			Value2 = value2,
// 			Node = new GreaterThanOrEquals<T>("GreaterThanOrEqual", type),
...
// 			Value1 = value1,
// 			Value2 = value2,
// 			Node = new NotEquals<T>("NotEquals", type),
// 			NodeName = "NotEquals",
// 			Comparer = (a, b) => a.CompareTo(b) != 0,
// 		};
// 	}
...
// 			Value1 = value1,
// 			Value2 = value2,
// 			Node = new LessThan<T>("LessThan", type),
// 			NodeName = "LessThan",
// 			Comparer = (a, b) => a.CompareTo(b) < 0,
// 		};
// 	}
...
// 			Value1 = value1,
// 			Value2 = value2,
// 			Node = new LessThanOrEquals<T>("LessThanOrEquals", type),
...
// 			.AddNode(new Branch("Branch1", true))
// 			.AddNode(new Branch("Branch2", false))
...
// 			.AddNode(new Pick<string>("Pick1", "string", "Hello", "World", true))
// 			.AddNode(new Pick<int>("Pick2", "int", 1, 2,false))
// 			.ConnectEntry("Set_Result1")
// 			.ConnectExecution("Set_Result1", "Set_Result2")
...
// 			.AddNode(new MapValue<int, string>("MapValue", "int", "string", input, "Default", dict.Keys.ToList(), dict.Values.ToList()))
// 			.ConnectEntry("Set_Result")
...
// 		var graph = new TestGraphBuilder(BlueprintVersion.Version)
// 			.AddOutputWithNode("Result", "boolean")
// 			.AddNode(new CreateSceneNode("CreateSceneNode", "Node"))
// 			.AddNode(new IsNull<object>("IsNull", UBFTypes.SceneNode))
...
// 			.AddOutputWithNode("Result", "boolean")
// 			.AddNode(new IsNull<object>("IsNull", "SceneNode"))
// 			.ConnectEntry("Set_Result")

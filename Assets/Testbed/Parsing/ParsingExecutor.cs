...
namespace Testbed.Parsing
{
	...
	public class ParsingExecutor : MonoBehaviour
	{
		...
		private IEnumerator RunRoutine()
		{
			...
			var parsingCatalogLoader = new CatalogResourceLoader(_parsingCatalogUri);
			...
			ArtifactProvider.Instance.RegisterCatalog(parsingCatalog);
			...
			var renderCatalogLoader = new CatalogResourceLoader(_renderCatalogUri);
			...
			ArtifactProvider.Instance.RegisterCatalog(renderCatalog);

...
namespace Futureverse.UBF.Runtime
{
	...
	{
		public static readonly Version MinSupportedStandardVersion = Version.Parse("2.0.0");
		public static readonly Version MaxSupportedStandardVersion = Version.Parse("2.0.0");
